                ...
                <Card className="p2p-card">
                    <a href="/p2p/orders" className="p2p-order-card" style={{ "border-bottom": "1px solid #000" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            className="bi bi-archive p2p-order-icon align-middle" viewBox="0 0 16 16">
                            <path
                    ...
                    <a className="p2p-order-card">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#00ffff"
                            className="bi bi-plus-circle p2p-order-icon align-middle" viewBox="0 0 16 16">
